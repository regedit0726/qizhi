...
public class WXBizMsgCrypt
{
    ...
    public WXBizMsgCrypt()
            throws AesException
    {
        if (WechatThirdInformation.aesKey.length() != 43)
        {
            throw new AesException(AesException.IllegalAesKey);
        }

        this.token = WechatThirdInformation.token;
        this.appId = WechatThirdInformation.appID;
        aesKey = Base64.decodeBase64(WechatThirdInformation.aesKey + "=");
            ...
            String nonce, String encrypt) throws AesException
    {
        ...
        if (signature == null || (!signature.equals(msgSignature)))
        {
